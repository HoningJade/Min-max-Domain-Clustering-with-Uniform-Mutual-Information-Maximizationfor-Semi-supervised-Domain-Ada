...
A novel SSDA method that minimizes Jenson-Shannon divergence and uses a attention-based adversarial loss along with adaptive confidence thresholding.
...
Our repo is implemented based on the original MME method [Semi-supervised Domain Adaptation via Minimax Entropy (ICCV 2019)](https://arxiv.org/pdf/1904.06487.pdf):
